    ...
    <el-dialog
      ...
      <div class="farmTable" v-show="diaParam.showType == 'table'">
        ...
        <el-pagination
          background
          layout="total, prev, pager, next"
          :total="diaParam.totalCount"
          :page-size="diaParam.tableParams.pageSize"
          @current-change="queryDiaData"
          :current-page="diaParam.tableParams.pageNnum" v-show="diaParam.totalCount > diaParam.tableParams.pageSize">
        </el-pagination>
      </div>
    ...
    export default {
        ...
        methods: {
            ...
            getDataList () {
                ...
                this.$api.land.farmBlockPage(params).then(res => {
                    if (res.success) {
            ...
            queryDiaData(page) {
                this.diaParam.tableParams.pageNnum = page
                this.getFarmList()
            }
        }
    }
