  ...
  <div class="app-container land_farm">
    <el-card class="filter-container" shadow="never">
      <el-form :inline="true" :model="searchFormData" size="small" label-width="100px" class="demo-form-inline">
        <el-form-item label="菜品名称" v-model="searchFormData.name">
          <el-input style="width: 203px" placeholder="菜品名称"></el-input>
        </el-form-item>
        <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$api.sms.recommendSchemeList(params).then(res=>{
          if (res.success) {
      ...
      // 删除接口
      farmDelete(id) {
        this.$api.land.farmDelete({farmId: id}).then(res=>{
          if (res.success) {
            this.getDataList()
          }
